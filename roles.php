...
<body>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse show" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link fw-bold active rounded shadow" href="roles.php" style="background-color: #CDEBFC;">Roles</a>
                    </li>
                    <li class="nav-item">
    ...
    <div class="container w-50 mt-5 rounded shadow" style="background-color: #EFF5F8;">
        ...
        <form action="rolesResult.php" method="post" class="row g-3">
            <div class="col-md-6">
